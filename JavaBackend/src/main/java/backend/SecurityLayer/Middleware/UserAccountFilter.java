...
public class UserAccountFilter extends OncePerRequestFilter {
    ...
    public UserAccountFilter(JWTUtility jwtUtility, UserService userDetailsService, AccountDAO accountDAO) {
        this.jwtUtility = jwtUtility;
        this.userDetailsService = userDetailsService;
        this.accountDAO = accountDAO;
    }
    @Bean
    public FilterRegistrationBean<UserAccountFilter> userAccountFilter(JWTUtility jwtUtility, UserService userService, AccountDAO accountDAO) {
        FilterRegistrationBean<UserAccountFilter> registrationBean = new FilterRegistrationBean<>();
        registrationBean.setFilter(new UserAccountFilter(jwtUtility, userService, accountDAO));
        registrationBean.addUrlPatterns("/*"); // or specify your desired URL patterns
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/**").hasRole(RoleTypes.ADMIN.toString())
                        // Requires the user to have the 'MANAGER' role OR 'ADMIN'

                        // Requires the user to be authenticated, regardless of role
